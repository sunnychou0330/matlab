...
function PSO(profile)
datafile = profile.datafile;
load(datafile);
nVar = numel(services);           % Number of Decision Variables

VarSize=[1 nVar];              % Size of Decision Variables Matrix

VarMin = 0;                % Lower Bound of Variables
VarMax = profile.UB;         % Upper Bound of Variables
...
for i=1:nPop
    ...
    % Evaluation
    particle(i).Cost = fitness(particle(i).Position, services);
